...
export const PERMISSIONS = {
  ...
  // Source data
  SOURCE_CREATE:           ['TECHNICIAN', 'COORDINATOR'],
  ...
  AE_CREATE:               ['PI', 'COORDINATOR', 'TECHNICIAN'],
  AE_MANAGE:               [ 'PI', 'COMPLIANCE'],
  AE_DELETE:               [ 'PI', 'COORDINATOR', 'TECHNICIAN'],
  AE_FOLLOWUP_VIEW:        ['ADMIN', 'PI', 'COMPLIANCE', 'AUDITOR'],
  AE_FOLLOWUP_CREATE:      [ 'PI', 'COORDINATOR', 'COMPLIANCE'],
  AE_FOLLOWUP_DELETE:      ['PI', 'COORDINATOR', 'COMPLIANCE'],
